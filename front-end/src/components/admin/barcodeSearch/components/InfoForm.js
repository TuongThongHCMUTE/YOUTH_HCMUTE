            ...
            <Grid container sx={{ display: "flex", flexWrap: "wrap" }}>
                ...
                <DatePicker
                  ...
                  value={
                    values?.ngaySinh
                      ...
                      : moment("1990-01-01").format("YYY-MM-DD")
                  }
              ...
              <Grid item xs={6} sx={{ p: 2 }}>
                ...
                >
                  ...
                  {errors.donVi && (
                    <FormHelperText>{errors.donVi}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              <Grid item xs={6} sx={{ p: 2 }}>
                ...
                >
                  ...
                  >
                    {[
                      ...
                      ...classes?.filter(
                        (i) => i.donVi._id === values?.donVi?._id
                      ),
                    ].map((c) => (
                  ...
                  {errors.lopSV && (
                    <FormHelperText>{errors.lopSV}</FormHelperText>
                  )}
                </FormControl>
              </Grid>
              <Grid item xs={6} sx={{ p: 2 }}>
                  ...
                  <Grid item xs={6} sx={{ p: 2 }}>
                    ...
                    >
                      ...
                      <Select
                        ...
                        value={
                          values?.thongTinDoanVien?.trangThaiSoDoan ||
                          "CHUA_NOP"
                        }
